...
export const Card = ({ name, isWebPage, description, techs, repository, visit }: CardProps) => {
    return isWebPage ? (
        <Box _hover={{ transform: 'translateY(-7px)', borderColor: 'gray.100' }} transition='border 0.2s, ease 0s, transform 0.2s' borderWidth='1px' borderColor='gray.50' boxShadow='lg' padding='7' w='350px' mt='6' minH='350px' bgColor='purple.900' borderRadius='10px' color='gray.50'>
